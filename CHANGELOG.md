...
- **UX & Accessibility Validation (`docs/validation/ux-validation.md`)**: Assessed user onboarding, 5-pose guided enrollment, desktop HUD, and evaluated interaction paths against applicable WCAG criteria.
