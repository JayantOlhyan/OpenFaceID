...
| :--- | :---: | :---: | :---: | :---: |
| **Cold Daemon Boot** | ~350 ms | < 500 ms | **329.6 ms** | Comparable / **WITHIN BUDGET** |
| **Frame Ingest (640x480)** | 0.52 ms | < 1.0 ms | **0.149 ms** | Microbenchmark / **WITHIN BUDGET** |
| **BlazeFace Detection** | 16.24 ms | < 25.0 ms | **0.165 ms** | **NOT DIRECTLY COMPARABLE** / In-tree analytical |
| **ArcFace 512D Embedding** | 6.38 ms | < 10.0 ms | **0.205 ms** | **NOT DIRECTLY COMPARABLE** / In-tree analytical |
...
| **Analytical Pipeline Total**| 26.70 ms | < 50.0 ms | **0.578 ms** | **NOT DIRECTLY COMPARABLE** / In-tree analytical |
