...
export const REGISTERED_MODELS: Record<string, ModelMetadata> = {
  ...
  'liveness-pad-evaluator': {
    name: 'Multi-Cue Heuristic Presentation Attack Detector (Anti-Spoofing)',
    version: '1.0.0',
    type: 'liveness',
    source: 'OpenFaceID Multi-Cue Heuristic PAD (Temporal EAR + Optical Micro-Motion, Uncertified)',
    codeLicense: 'Apache-2.0',
    weightsLicense: 'Apache-2.0',
